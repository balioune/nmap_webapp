...
function newscan() {
	$('#modaltitle').html('<i class="material-icons">wifi_tethering</i> New WAN Site Scan');
	$('#modalbody').html(
		'Run a new WAN site scan by setting the following 3 parameters:'+
...
function startscan() {
	...
	$.post('/api/v1/nmap/scan/new', {
		...
		if(typeof(d['error']) != 'undefined') {
			...
			swal("Started", "Your new WAN site scan is running...", "success");
		}
	});
}
